...
ofpat_group_create (uint32_t group_id, enum ofp_group_type type) {
    ...
    ${p4_pd_prefix}ofpat_group_ingress_match_spec_t ms;
    ${p4_pd_prefix}ofpat_group_ingress_mc_action_spec_t as;
    ...
    status |= ${p4_pd_prefix}ofpat_group_ingress_table_add_with_ofpat_group_ingress_mc
