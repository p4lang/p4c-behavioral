...
//:: if enable_pre:
    ...
    i32             mc_mgrp_destroy   (1: res.SessionHandle_t sess_hdl, 2: McHandle_t grp_hdl);
    McHandle_t      mc_node_create    (1: res.SessionHandle_t sess_hdl, 2: i32 dev_id, 3: i16 rid, 4: binary port_map, 5: binary lag_map);
    i32             mc_node_update    (1: res.SessionHandle_t sess_hdl, 2: McHandle_t l1_hdl, 3: binary port_map, 4: binary lag_map);
    i32             mc_node_destroy   (1: res.SessionHandle_t sess_hdl, 2: McHandle_t l1_hdl);
    i32             mc_associate_node (1: res.SessionHandle_t sess_hdl, 2: McHandle_t grp_hdl, 3: McHandle_t l1_hdl);
    i32             mc_dissociate_node(1: res.SessionHandle_t sess_hdl, 2: McHandle_t grp_hdl, 3: McHandle_t l1_hdl);
